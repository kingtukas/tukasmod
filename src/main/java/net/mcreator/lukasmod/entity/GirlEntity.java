...
package net.mcreator.lukasmod.entity;
...
import net.mcreator.lukasmod.item.EndswordItem;
import net.mcreator.lukasmod.LukasModModElements;

@LukasModModElements.ModElement.Tag
public class GirlEntity extends LukasModModElements.ModElement {
	public static EntityType entity = null;
	public GirlEntity(LukasModModElements instance) {
		super(instance, 10);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f)).build("girl")
						.setRegistryName("girl");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -3394561, -6750055, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("girl"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			biome.getSpawns(EntityClassification.MONSTER).add(new Biome.SpawnListEntry(entity, 4, 4, 4));
		}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("lukas_mod:textures/f46c24db057910e9.png");
				}
			};
	...
	public static class CustomEntity extends VillagerEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(EndswordItem.block, (int) (1)));
		}
